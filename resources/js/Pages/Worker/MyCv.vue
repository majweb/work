                            ...
                            <section class="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                                <div class="p-4 sm:p-8">
                                    <div class="flex justify-between items-center mb-6 sm:mb-8 text-center sm:text-left">
                                        ...
                                        <div v-if="selectedCv.pathCv" class="shrink-0">
                                            <a :href="selectedCv.pathCv"
                                               target="_blank"
                                               download
                                               class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors shadow-sm text-xs font-bold uppercase">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                </svg>
                                                {{ __('translate.downloadCV') }}
                                            </a>
                                        </div>
                                    </div>
