                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div
                        ...
                        <div class="col-span-6 flex mb-3 items-center">
                            <div class="mr-2">
                                <InputLabel value="Kwota faktury"/>
                                <TextInput
                                    id="amount"
                            ...
                            <div class="mr-2">
                                <InputLabel for="ends_at" value="Numer zamówienia"/>
                                <TextInput
                                    id="order_id"
                            ...
                            <div class="mr-2">
                                <PrimaryButton class="mt-6" @click="search">Szukaj</PrimaryButton>
                            </div>
                        </div>
