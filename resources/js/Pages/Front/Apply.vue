                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <Link :href="route('front.projects.single',project)"
                                  class="px-6 py-3 bg-[#0A2C5C] text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-[#00a0e3] transition-all shadow-lg shadow-blue-900/20 hover:-translate-y-0.5 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                        ...
                        <div v-show="formStep == 1" class="space-y-12 animate-fade-in">
                            ...
                            <div class="col-span-2 pt-4">
                                ...
                                <div
                                    ...
                                    ></file-pond>
                                    <InputError :message="form.errors.files" class="mt-2 text-[10px] font-bold uppercase tracking-widest"/>
                                </div>
                                ...
                                <div v-if="props.agreements && props.agreements.length > 0" class="col-span-6 pt-8">
                                    <div
                                        ...
                                        <div v-if="props.agreements.length > 1"
                                             class="mb-4 flex items-center gap-4 p-5 bg-white rounded-2xl border border-gray-100 hover:border-[#00a0e3] transition-all shadow-sm group">
                                        ...
                                        <div class="space-y-3">
                                        <div v-for="(agreement, index) in props.agreements" :key="agreement.id"
