        ...
        <div class="py-24 bg-gray-50/50 dark:bg-gray-900/50 min-h-screen relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div class="text-center mb-12">
                    ...
                    <!-- Tabs Navigation -->
                    <div class="inline-flex p-1.5 bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700">
                        <button
                            @click="activeTab = 'general'"
                            :class="[activeTab === 'general' ? 'bg-[#0A2C5C] text-white shadow-lg' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300']"
                        ...
                        <button
                            ...
                            :class="activeTab === 'candidate' ? 'bg-[#0A2C5C] text-white shadow-lg' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'"
                            class="px-8 py-3 rounded-[1.5rem] text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300"
                        >
