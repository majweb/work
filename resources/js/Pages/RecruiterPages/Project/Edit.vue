...
const form = useForm({
    ...
    langs: (props.project.langs || []).map(l => ({
        name: usePage().props.languages?.find(lang => lang.value === (l.name?.value || l.name)) || l.name,
        level: props.langLevels?.find(level => level.id === (l.level?.id || l.level)) || l.level
    })),
...
const fillAddressFromGeocoder = (place) => {
    ...
    // Dodaj to: Przypisanie współrzędnych
    if (place.center) {
    ...
    <AppLayout :title="__('translate.updateProject')">
        <div class="py-6 bg-gray-50 min-h-screen">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    <Link
                        :href="route('project-recruits.show', props.project.id)"
                    ...
                    <div v-show="currentStep === 1" class="space-y-8">
                        ...
                        <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 p-10">
                            ...
                            <div class="mb-8 md:mb-12">
                                <div class="bg-gradient-to-br from-[#0A2C5C] to-blue-900 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 shadow-2xl shadow-blue-900/20 relative group opacity-60 grayscale-[20%]">
                                    <!-- Dekoracyjne tło -->
                                                ...
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-[11px] font-bold text-red-600 leading-tight">
                                                            {{ form.errors.category || form.errors.categorySub || form.errors.profession }}
                                                        </p>
                                                        <p class="text-[9px] font-medium text-red-400 mt-1 uppercase tracking-tight">
