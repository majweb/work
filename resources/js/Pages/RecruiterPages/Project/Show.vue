                        ...
                        <div class="bg-gray-50/50 rounded-[2rem] p-6 border border-gray-100/50 lg:col-span-2">
                            ...
                            <p class="text-sm font-black mb-6 uppercase tracking-tight"
                               :class="props.project.is_active ? 'text-green-600' : 'text-gray-400'">
                                {{ props.project.is_active ? __('translate.recruitmentActive') : __('translate.inactiveStatus') }}
                            </p>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                                <div class="bg-white rounded-xl p-3 shadow-sm border border-gray-100 flex flex-col items-center justify-center min-w-0">
                                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest truncate w-full text-center mb-1">{{ __('translate.statusYes') }}</div>
                                    <div class="text-lg font-black text-[#0A2C5C]">{{ props.project.yes_count || 0 }}</div>
                                </div>
                                <div class="bg-white rounded-xl p-3 shadow-sm border border-gray-100 flex flex-col items-center justify-center min-w-0">
                                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest truncate w-full text-center mb-1">{{ __('translate.statusNo') }}</div>
                                    <div class="text-lg font-black text-red-600">{{ props.project.no_count || 0 }}</div>
                                </div>
                                <div class="bg-white rounded-xl p-3 shadow-sm border border-gray-100 flex flex-col items-center justify-center min-w-0">
                                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest truncate w-full text-center mb-1">{{ __('translate.statusMaybe') }}</div>
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 p-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-gray-50/50 p-6 rounded-[2rem] border border-gray-100/50" v-if="props.project.kraz">
                                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">{{ __('translate.kraz') }}</p>
                                    <p class="text-xl font-black text-gray-900 tracking-widest">{{ props.project.kraz }}</p>
                                </div>
                        ...
                        <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 p-10" v-if="props.project.detailprojects && props.project.detailprojects.length > 0">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <span v-for="(duty, index) in props.project.detailprojects" :key="index"
                                    ...
                                    {{ duty.allTranslations?.title?.[usePage().props.language] || duty.allTranslations?.name?.[usePage().props.language] || duty.name?.[usePage().props.language] || duty.name }}
                                </span>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-gray-50/50 p-6 rounded-[2rem] border border-gray-100/50" v-if="props.project.salary_period">
                                    ...
                                    <p class="text-sm font-black text-[#0A2C5C] uppercase tracking-tight">
                                        {{ props.project.salary_period?.allTranslations?.name[usePage().props.language] || props.project.salary_period?.name?.[usePage().props.language] || props.project.salary_period?.name }}
                                    </p>
                                </div>
