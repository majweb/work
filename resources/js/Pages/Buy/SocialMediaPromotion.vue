                    ...
                    <div class="flex flex-col md:flex-row gap-12 items-center">
                        <div class="md:w-1/2">
                            ...
                            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-6">
                                {{ __('translate.social_media_subtitle') }}
                            </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div class="group flex flex-col items-center text-center">
                            ...
                            <ul class="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-loose text-left list-none space-y-1">
                                <li v-for="(item, index) in __('translate.social_media_what_content').split('\n')" :key="item" class="flex items-start gap-2">
                                    <div v-if="index !== 0" class="w-1.5 h-1.5 rounded-full bg-[#00a3e0] flex-shrink-0 mt-1.5"></div>
                                    <span :class="{'ml-3.5': index === 0}">{{ item.replace('• ', '').replace('•', '') }}</span>
                                </li>
                            </ul>
                        </div>
