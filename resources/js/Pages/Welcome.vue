...
<template>
    ...
    <Head>
    <meta property="og:title" content="Strona główna - work4global" head-key="title" />
    <meta property="og:description" content="tu bedzie opis" head-key="description" />
    <meta property="og:image" content="https://abctest.pl/images/logo.png" head-key="image" />
    <meta property="og:url" content="https://abctest.pl" head-key="url" />
