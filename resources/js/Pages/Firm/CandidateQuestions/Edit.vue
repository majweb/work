            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-8 flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-4">
                        <span class="text-xs font-black text-[#1a335d] uppercase tracking-[0.2em]">{{ __('translate.status') }}</span>
                        <button
                            type="button"
                            @click="form.is_active = !form.is_active"
                            class="relative inline-flex h-7 w-14 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none shadow-inner"
