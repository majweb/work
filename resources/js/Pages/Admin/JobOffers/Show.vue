            ...
            <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <a
                            :href="route('front.projects.single', props.project.id)"
                            target="_blank"
                            class="inline-flex items-center gap-2 rounded-2xl border border-blue-100 bg-blue-50 px-6 py-3 text-xs font-black uppercase tracking-widest text-blue-600 shadow-sm hover:bg-blue-100 transition-all hover:-translate-y-0.5"
                        >
