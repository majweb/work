...
const validateStep = async (step) => {
    ...
    try {
        const response = await axios.post(route('admin.job-offers.validate-step'), {
            step: step,
            ...form.data()
        });
...
watch(() => form.category, async (category) => {
    if (form.category) {
        optionsSubCategory.value =(await axios.get(route('admin.job-offers.getChildsCategory',category.value))).data
    }
...
watch(() => form.categorySub, async (categorySub) => {
    if (form.categorySub) {
        optionsProfession.value =(await axios.get(route('admin.job-offers.getChildsCategory',categorySub.value))).data
    }
    optionsPosition.value = [];
    form.profession = '';
    form.position = '';
...
watch(() => form.profession, async (profession) => {
    if (form.profession) {
        const response = await axios.get(route('admin.job-offers.getChildsCategory', profession.value));
        optionsPosition.value = response.data;
    }
    form.position = '';
    form.detailProjects = [];
...
const updateProject = () => {
    form.put(route('admin.job-offers.update',props.project), {
...
onMounted(async () => {
    ...
    if (form.category && form.category.value) {
        try {
            optionsSubCategory.value = (await axios.get(route('admin.job-offers.getChildsCategory', form.category.value))).data;
        } catch (error) {
    ...
    if (form.categorySub && form.categorySub.value) {
        try {
            optionsProfession.value = (await axios.get(route('admin.job-offers.getChildsCategory', form.categorySub.value))).data;
        } catch (error) {
    ...
    if (form.profession && form.profession.value) {
        try {
            optionsPosition.value = (await axios.get(route('admin.job-offers.getChildsCategory', form.profession.value))).data;
        } catch (error) {
