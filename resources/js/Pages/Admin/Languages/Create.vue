            ...
            <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 p-10 mb-8">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div>
                            <h3 class="text-2xl font-black text-[#0A2C5C] uppercase tracking-tight">Dodaj nowy język</h3>
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">
                                Wprowadź kod języka oraz jego nazwy w różnych tłumaczeniach. Języki te są wykorzystywane przy generowaniu szablonu CV podczas aplikacji.
                            </p>
                        </div>
                        <Link
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                <div class="p-8 bg-blue-50/50 rounded-[2rem] border border-blue-100/50 space-y-6">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <InputLabel for="code" value="Kod języka (np. PL, EN, DE)" class="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 ml-1" />
                                            <TextInput
                                                id="code"
                                                v-model="form.code"
                                                type="text"
                                                maxlength="2"
                                                placeholder="Wprowadź 2 znaki"
                                                class="block w-full !bg-white !border-none !rounded-2xl !py-4 shadow-sm focus:ring-2 focus:ring-blue-500/20 transition-all font-medium uppercase"
                                            />
                                            <div v-if="form.errors.code" class="mt-2 text-xs font-bold text-red-500 uppercase tracking-wider ml-1">{{ form.errors.code }}</div>
                                            <p class="mt-2 text-[9px] text-gray-400 font-bold uppercase tracking-widest ml-1">Kod zostanie automatycznie zamieniony na małe litery w wartości i duże w nazwie stałej.</p>
                                        </div>
                                    </div>
                                </div>
