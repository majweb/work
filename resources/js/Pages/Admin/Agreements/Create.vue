...
const submit = () => {
    form.post(route('admin.agreements.store'));
};
</script>

<template>
    <AppLayout title="Dodaj nową zgodę">
            ...
            <div class="max-w-[1200px] mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 p-10 mb-8">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div>
                            <h3 class="text-2xl font-black text-[#0A2C5C] uppercase tracking-tight">Dodaj nową zgodę</h3>
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">
                                Utwórz nową treść zgody dla wybranych typów formularzy
                            </p>
                        </div>
                ...
                <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 overflow-hidden">
                    <form @submit.prevent="submit" class="p-10">
                                ...
                                <div class="pt-4 flex flex-col gap-6">
                                    <label class="flex items-center cursor-pointer group ml-1">
                                        <div class="relative">
                                            ...
                                            <div class="w-14 h-8 bg-gray-100 rounded-full transition-colors group-hover:bg-gray-200" :class="{'!bg-[#00AEEF]': form.is_active}"></div>
                        ...
                        <div class="mt-12 pt-10 border-t border-gray-50 flex justify-end">
                            ...
                            >
                                <span v-if="!form.processing">Zapisz zgodę</span>
