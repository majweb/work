                                ...
                                <tr v-for="firm in firms.data" :key="firm.id" class="border-b border-gray-50 hover:bg-gray-50/50 transition-all group">
                                    ...
                                    <td class="py-8 px-8 text-right relative context-menu-container">
                                        ...
                                        >
                                            ...
                                            <button @click="impersonate(firm.id)" class="flex items-center gap-3 w-full px-5 py-4 text-[10px] font-black text-gray-600 hover:text-[#0A2C5C] hover:bg-gray-50 rounded-2xl transition-all uppercase tracking-widest group">
                                                <div class="w-8 h-8 rounded-xl bg-orange-50 flex items-center justify-center group-hover:bg-[#0A2C5C] transition-colors">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 text-orange-400 group-hover:text-white transition-colors">
