            ...
            <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 p-10 mb-8">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        <div>
                            <h3 class="text-2xl font-black text-[#0A2C5C] uppercase tracking-tight">Dodaj nowy kraj</h3>
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">
                                Wprowadź dane kraju oraz tłumaczenia dla wszystkich języków
                            </p>
                        </div>
                        <Link
                ...
                <div class="bg-white rounded-[3rem] shadow-xl shadow-blue-900/5 border border-gray-100 p-10">
                    <form @submit.prevent="submit" class="space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                <div class="p-8 bg-blue-50/50 rounded-[2rem] border border-blue-100/50 space-y-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            <InputLabel for="selectedContinent" value="Wybierz kontynent (autouzupełnianie)" class="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 ml-1" />
                                            <select
                            ...
                            <!-- Translations Table Header/Info -->
                            <div class="space-y-6">
                                <div class="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-4">
                                    ...
                                    <p class="text-sm text-gray-500 leading-relaxed font-medium">
                                        Musisz uzupełnić nazwę kraju oraz kontynent we wszystkich obsługiwanych językach. Skróty języków pochodzą z konfiguracji <code class="text-blue-500 font-bold">langsShorts</code>.
                                    </p>
                                </div>
                            </div>
                        </div>
