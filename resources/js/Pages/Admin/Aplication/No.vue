...
const resetFilters = () => {
    ...
    router.get(route('admin.aplicationsA.noApplications'), {}, {
        preserveState: true,
        replace: true,
    });
};
...
watch(form, debounce(function (value) {
    ...
    router.get(route('admin.aplicationsA.noApplications'), rest, {
        preserveState: true,
        preserveScroll: true,
        replace: true
    });
    ...
    <AppLayout :title="__('translate.aplications')">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{__('translate.aplications')}} - {{ __('translate.statusNo') }}
            </h2>
        </template>
                ...
                <div class="bg-white shadow-xl sm:rounded-lg p-6">
                    ...
                    <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="flex space-x-2 mt-2">
                            <Link v-if="otherCount > 0" :href="route('admin.aplicationsA.index')" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            ...
                            <tr v-for="application in applications.data" :key="application.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex gap-2">
                                        ...
                                        <span
                                                :class="['bg-red-600 text-white', 'px-3 py-1 rounded text-xs font-medium']">
