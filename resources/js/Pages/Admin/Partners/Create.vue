                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="px-3 py-1 bg-blue-50 text-[#0A2C5C] text-[8px] font-black uppercase tracking-widest rounded-lg border border-blue-100">Nowy Partner</span>
                                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Tworzenie nowej pozycji w systemie</p>
                                </div>
                            </div>
                        </div>
                    </div>
