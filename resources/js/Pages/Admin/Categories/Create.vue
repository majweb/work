...
const submit = () => {
    if (!form.selectedIndustry || !form.selectedSubIndustry || !form.selectedProfession) {
        form.errors.parent_id = 'Wybór branży, podbranży i zawodu jest wymagany przy dodawaniu stanowiska.';
        return;
    }
