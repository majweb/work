    ...
    <div>
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <TextInput
                        ...
                        autofocus
                    />
                    <InputError :message="createApiTokenForm.errors.name" class="mt-2 text-[10px] font-bold uppercase tracking-widest" />
                </div>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token" class="mt-4 bg-gray-100 px-4 py-2 rounded font-mono text-sm text-[#0A2C5C] break-all">
