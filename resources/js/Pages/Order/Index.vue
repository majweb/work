            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                        ...
                        <h2 class="text-sm font-semibold text-blue-300">{{__('translate.filters')}}</h2>
                        <button class="text-sm font-semibold mb-2 text-blue-400 underline" @click="resetFilters" v-if="(params.payment_type && params.payment_type != 'all') || (params.paid_date && params.paid_date != 'paid-all')">{{ __('translate.clearFilters') }}</button>
                        <div class="col-span-6 flex mb-3 items-center">
                            <div class="flex mt-1 flex flex-col mr-2">
                                ...
                                <select v-model="params.payment_type" id="small" class="border-gray-300 focus:border-[#00a0e3] focus:ring-[#00a0e3] rounded-md shadow-sm"
                                >
                            ...
                            <div class="flex mt-1 flex flex-col">
                                ...
                                <select v-model="params.paid_date" id="small" class="border-gray-300 focus:border-[#00a0e3] focus:ring-[#00a0e3] rounded-md shadow-sm"
                                >
