        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="inline-flex items-center bg-white rounded-full shadow-sm border border-blue-200 px-6 py-3 divide-x divide-gray-200">
                        <div class="flex items-center gap-2 pr-6">
                            <img src="/images/icons/firm/liczba_ofert.svg" class="w-20 h-20" alt="ofert">
                            <span class="text-sm font-bold text-[#0d2a52]">
                                {{ stats.total_projects }} {{ __('translate.offers_count') }}
                            </span>
                        </div>
                        <div class="flex items-center gap-2 px-6">
                            <img src="/images/icons/firm/liczba_aplikacji.svg" class="w-20 h-20" alt="aplikacji">
                            <span class="text-sm font-bold text-[#0d2a52]">
                                {{ stats.total_aplications }} {{ __('translate.applications_count') }}
                            </span>
                        </div>
                        <div class="flex items-center gap-2 px-6">
                            <img src="/images/icons/firm/liczba_aktywnych.svg" class="w-20 h-20" alt="aktywne">
                            <span class="text-sm font-bold text-[#0d2a52]">
                                {{ stats.active_projects }} {{ __('translate.active_count') }}
                            </span>
                        </div>
                        <div class="flex items-center gap-2 pl-6">
                            <img src="/images/icons/firm/liczba_zakonczonych.svg" class="w-20 h-20" alt="zakończone">
                            <span class="text-sm font-bold text-[#0d2a52]">
                                {{ stats.inactive_projects }} {{ __('translate.finished_count') }}
                            </span>
                        </div>
                    </div>
                </div>
