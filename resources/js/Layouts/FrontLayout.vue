...
<template>
    <div>
        ...
        <Banner />
<!--        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50 bg-no-repeat bg-center bg-cover" style="background-image: url('/images/test.png')">-->
        ...
        <footer class="relative border-t border-gray-200 bg-white dark:bg-gray-950 dark:border-gray-800">
          ...
          Work4You.global
                ...
                <!-- Divider -->
                <div class="my-10 h-px w-full bg-gray-200 dark:bg-gray-800"></div>
