...
class StoreProject extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'disability_friendly' => ['nullable', 'boolean'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'salary_type' => strtolower(__('translate.salary_type')),
            'inclusive_recruitment' => strtolower(__('translate.sickPeople')),
            'disability_friendly' => strtolower(__('translate.disability_friendly')),
