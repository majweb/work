...
class ProjectController extends Controller
{
    ...
    public function update(StoreProject $request, Project $project)
    {
        ...
        $project->update([
            ...
            'workingMode' => $projectData['workingMode'],
            'typeOfContract' => $projectData['typeOfContract'],
            'payoutMode' => $projectData['payoutMode'],
            'workingPlace' => $projectData['workingPlace'],
            'country' => $projectData['country'],
            'workLoad' => $projectData['workLoad'],
            'shiftWork' => $projectData['shiftWork'],
            'paySystem' => $projectData['paySystem'],
            'days' => $projectData['days'],
            'workNight' => $projectData['workNight'],
            'basicSalaryTo' => $projectData['basicSalaryTo'],
            'basicSalaryFrom' => $projectData['basicSalaryFrom'],
            'salary_type' => $projectData['salary_type'],
            'salary_period' => $projectData['salaryPeriod'] ?? null,
            'inclusive_recruitment' => $projectData['inclusive_recruitment'] ?? false,
            'disability_friendly' => $projectData['disability_friendly'] ?? false,
            'bonusSalaryTo' => $projectData['bonusSalaryTo'],
            'bonusSalaryFrom' => $projectData['bonusSalaryFrom'],
            'hoursFrom' => $projectData['hoursFrom'],
            'hoursTo' => $projectData['hoursTo'],
            'offer' => $projectData['offer'],
            'wait' => $projectData['wait'],
            'welcome' => $projectData['welcome'],
            'education' => $projectData['education'],
            'experience' => $projectData['experience'],
            'countryWork' => $projectData['countryWork'],
            'streetWork' => $projectData['streetWork'],
            'streetWorkNumber' => $projectData['streetWorkNumber'],
            'postalWork' => $projectData['postalWork'],
            'cityWork' => $projectData['cityWork'],
            'lat' => $projectData['lat'],
            'lng' => $projectData['lng'],
            'user_id' => auth()->user()->id,
            'recruiter_id' => $project->recruiter_id,
            'cv' => $projectData['cv'],
            'kraz' => $projectData['kraz'] ?? null,
            'langs' => $langs,
            'external_company_id' => $projectData['external_company_id'],
